...
public class LocationActivity extends Activity implements OnClickListener, OnItemClickListener, OnMapStatusChangeListener {
    ...
    private void init() {
        ...
        ImageView iv_location_cancle = (ImageView) findViewById(R.id.iv_location_cancle);
        iv_location_cancle.setOnClickListener(this);
        ImageView iv_location_ensure = (ImageView) findViewById(R.id.iv_location_ensure);
        iv_location_ensure.setOnClickListener(this);
        et_location = (EditText) findViewById(R.id.et_location);
        ImageView iv_location = (ImageView) findViewById(R.id.iv_location);
        iv_location.setOnClickListener(this);
        ListView lv_location = (ListView) findViewById(R.id.lv_location);
        ...
        // 定位图层显示方式
        LocationMode currentMode = MyLocationConfiguration.LocationMode.NORMAL;
