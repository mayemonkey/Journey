...
public abstract class MaterialSpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    public MaterialSpinnerBaseAdapter(Context context, List<String> list) {
        this.context = context;
        this.list = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //当前目录包含选中Image
        if (list != null) {
            if (list.contains(getItem(position).toString())) {
                textView.setTextColor(Color.parseColor("#51d3c4"));
            } else {
