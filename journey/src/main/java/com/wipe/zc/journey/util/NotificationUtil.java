...
public class NotificationUtil {
    ...
    public static void notificationShow(String inviter, Context packageContext) {
        NotificationManager nManager = (NotificationManager) MyApplication.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
//        Notification notification = new Notification(R.drawable.icon_icon, "行程好友邀请", System.currentTimeMillis());


        Intent notificationIntent = new Intent(packageContext, MessageActivity.class);
        PendingIntent contentIntent = PendingIntent.getActivity(packageContext, 0, notificationIntent, 0);
